...
SPtr<Scene> loadBasicScene(const Context &context, glm::vec3 spawnLocations[4], std::function<void(Scene &scene, SPtr<Model> boxModel)> callback, bool addPlayers = true) {
